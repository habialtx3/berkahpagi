        ...
        <>
            ...
            <header className="mb-12">
                ...
                <p className="text-xl text-on-surface-variant max-w-2xl leading-relaxed">
                    Manage your artisan orchard harvest. Track quantities across cold storage
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <div className="bg-surface-container-lowest p-8 rounded-xl shadow-sm border border-outline-variant/10">
                    <div className="flex items-center gap-4 mb-4">
                        ...
                        <span className="font-bold text-on-surface-variant">Total Items</span>
                    </div>
                ...
                <div className="flex flex-wrap gap-6">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <select className="bg-surface-container-lowest border-none rounded-full py-3 px-6 pr-12 focus:ring-2 focus:ring-primary/30 font-semibold text-on-surface min-w-[200px]">
                            ...
                            <option>Pome Fruits (Apples/Pears)</option>
                            <option>Stone Fruits</option>
                            <option>Artisan Preserves</option>
                            <option>Honey &amp; Syrups</option>
                        </select>
                    </div>
                </div>
                        ...
                        <tr className="hover:bg-accent/30 transition-colors group">
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="w-16 h-16 rounded-xl overflow-hidden bg-surface-container-high">
                                        <img
                                            ...
                                            data-alt="crisp red honeycrisp apples in a rustic wooden basket with natural lighting"
                            ...
                            <td className="px-8 py-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-on-surface-variant font-medium">units</span>
                        ...
                        <tr className="bg-accent transition-colors group">
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="w-16 h-16 rounded-xl overflow-hidden bg-surface-container-high">
                                        <img
                                            ...
                                            data-alt="close-up of artisan pear preserves in a glass jar with decorative twine and organic label"
                            ...
                            <td className="px-8 py-8">
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-on-surface-variant font-medium">jars</span>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="w-16 h-16 rounded-xl overflow-hidden bg-surface-container-high">
                                        <img
                                            ...
                                            data-alt="bottle of clear high-quality organic apple cider on a wooden background with soft cinematic light"
                            ...
                            <td className="px-8 py-8">
                                <div className="flex items-center gap-4">
                                    <div className="w-16 h-16 rounded-xl overflow-hidden bg-surface-container-high">
                                        <img
                                            alt="Bosc Pears"
                                            data-alt="ripe golden Bosc pears with textured skins on a natural stone surface, soft directional light"
            ...
            <div className="mt-12 flex justify-between items-center bg-surface-container-low/50 p-8 rounded-xl">
                <div className="text-lg font-medium text-on-surface-variant">
                    Showing <span className="text-on-surface font-bold">1 - 12</span> of{" "}
                    <span className="text-on-surface font-bold">48</span> products
                </div>
